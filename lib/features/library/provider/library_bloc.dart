...
class LibraryBloc extends Bloc<LibraryEvent, LibraryState> {
  ...
  Future<void> _onClearSearch(LibraryClearSearch event, Emitter<LibraryState> emit) async {
    emit(state.copyWith(searchQuery: '', filteredTracks: state.tracks, status: LibraryStatus.success));
  }

  Future<void> _onApplyFilter(_LibraryApplyFilter event, Emitter<LibraryState> emit) async {
    emit(state.copyWith(
